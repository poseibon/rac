 ...
 * @date 2020/12/11
 */
public enum UseExtPropertyEnum {

    YES(0, "使用扩展属性"), NO(1, "不使用扩展属性");
    ...
    UseExtPropertyEnum(Integer value, String text) {
        this.value = value;
        this.text = text;
    }
     ...
     * 枚举map
     */
    public static final Map<Integer, UseExtPropertyEnum> VALUE_TEXT = Maps.newHashMap();

    /**
     * 静态初始化
     */
    static {
        for (UseExtPropertyEnum item : values()) {
     ...
     */
    public static UseExtPropertyEnum of(Integer value) {
