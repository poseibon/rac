...
public class DimensionNodeSqlSupporter {

    public String insertSelective(DimensionNodePo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("tb_dimension_node");
        ...
        if (record.getDimensionId() != null) {
            sql.VALUES("dimension_id", "#{dimensionId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(DimensionNodePo record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_dimension_node");
        ...
        if (record.getDimensionId() != null) {
            sql.SET("dimension_id = #{dimensionId,jdbcType=BIGINT}");
        }
