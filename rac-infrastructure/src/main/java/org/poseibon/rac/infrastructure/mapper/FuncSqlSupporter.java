...
public class FuncSqlSupporter {

    public String insertSelective(FuncPo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("tb_func");
    ...
    public String updateByPrimaryKeySelective(FuncPo record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_func");
