...
public class MenuSqlSupporter {

    public String insertSelective(MenuPo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("tb_menu");
    ...
    public String updateByPrimaryKeySelective(MenuPo record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_menu");
